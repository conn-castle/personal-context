...
func TestParseInputFolderMinimal(t *testing.T) {
	dir := t.TempDir()
	writeFile(t, dir, "record.html", "<h1>Hello</h1>")
...
func TestParseInputFolderFull(t *testing.T) {
	dir := t.TempDir()
	writeFile(t, dir, "record.html", `<html><img src="figures/plot.png" alt="Plot"></html>`)
...
func TestParseInputFolderMissingRecordHTML(t *testing.T) {
	dir := t.TempDir()
	// No record.html
...
func TestParseInputFolderInvalidMetadataJSON(t *testing.T) {
	dir := t.TempDir()
	writeFile(t, dir, "record.html", "<h1>Test</h1>")
...
func TestParseInputFolderFigureRefValidation(t *testing.T) {
	...
	writeFile(t, dir, "record.html", `<img src="figures/plot.png">`)
...
func TestParseInputFolderMultipleFigureRefs(t *testing.T) {
	dir := t.TempDir()
	writeFile(t, dir, "record.html", `<img src="figures/a.png"><img src='figures/b.jpg'>`)
