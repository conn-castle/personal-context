...
describe("ScaledRecordFrame", () => {
  ...
  it("renders an iframe with the provided HTML content", () => {
    const { container } = render(
      <ScaledRecordFrame htmlContent="<p>Hello World</p>" />
    );
  ...
  it("sets iframe dimensions to the base width and height", () => {
    const { container } = render(
      <ScaledRecordFrame htmlContent="<p>Test</p>" baseWidth={800} baseHeight={600} />
    );
  ...
  it("uses default 1920x1080 dimensions when none specified", () => {
    const { container } = render(
      <ScaledRecordFrame htmlContent="<p>Default</p>" />
    );
  ...
  it("sandboxes the iframe with allow-same-origin only", () => {
    const { container } = render(
      <ScaledRecordFrame htmlContent="<p>Sandboxed</p>" />
    );
