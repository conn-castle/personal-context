...
interface ScaledRecordFrameProps {
  /** The HTML content to render in the record */
  htmlContent: string
  /** Base width of the record (default: 1920) */
  baseWidth?: number
  /** Base height of the record (default: 1080) */
  baseHeight?: number
  /** Additional class names for the outer container */
  className?: string
  /** Whether to show a shadow around the record */
  showShadow?: boolean
  /** Whether to show a border/ring around the record */
  showBorder?: boolean
  /** Vertical alignment of the record (default: 'center') */
  align?: 'top' | 'center'
}
 ...
 */
export function ScaledRecordFrame({
  htmlContent,
  baseWidth = 1920,
  baseHeight = 1080,
  className,
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        {/* The scaled record wrapper */}
        <div
          className={cn(
            'relative overflow-hidden bg-record-bg',
