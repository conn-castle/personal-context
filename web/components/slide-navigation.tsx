...
import type { SlideSummary, ViewMode } from "@/lib/types";
...
interface SlideNavigationProps {
  ...
  onSelectSlide: (slide: SlideSummary) => void;
  viewMode: ViewMode;
...
export function SlideNavigation({
  ...
  const groupedSlides = useMemo(() => groupSlidesByDateDesc(slides), [slides]);
