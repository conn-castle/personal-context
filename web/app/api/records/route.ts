...
/**
 * GET /api/records — lists records with pagination, filtering, and sorting.
 *
 * @param req - The incoming request.
 * @returns Paginated list of record summaries.
 */
export async function GET(
  ...
  try {
    ...
    const rows = (await sql(queryText, params)) as unknown as RecordSummary[];
